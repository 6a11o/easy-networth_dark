...
const AnimatedDataPoint = ({ 
  ...
  return (
    <div 
      className={`p-6 backdrop-blur-xl rounded-xl border border-white/10 transform transition-all duration-500 hover:scale-105 hover:shadow-lg hover:shadow-${color}/20`}
      style={{ 
        background: `linear-gradient(145deg, rgba(26,31,44,0.8) 0%, rgba(19,22,32,0.9) 100%)`,
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-baseline">
          <div className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-white/70">
            {symbol}{animatedValue.toLocaleString()}
          </div>
        </div>
        <div className={`w-full h-0.5 bg-gradient-to-r from-${color} to-transparent rounded-full overflow-hidden`}>
          <div className={`h-full w-2/3 bg-${color}/30 animate-shimmer`}></div>
        </div>
      </div>
    </div>
  );
...
const LandingPage = () => {
  // Example values for animated numbers
  const netWorth = 93000;
  const totalAssets = 115000;
  const totalLiabilities = 22000;
      ...
      <div className="w-full">
        ...
        <section className="w-full min-h-screen py-24 lg:py-32 relative overflow-hidden flex items-center">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-[#0a0d14] via-[#111827] to-[#0a0d14]">
            ...
            <div className="absolute inset-0 tech-particle-field"></div>
            ...
            {/* Glowing orbs */}
            <div className="absolute top-1/3 right-1/5 w-64 h-64 rounded-full bg-gradient-to-b from-[#33C3F0]/10 to-transparent blur-3xl"></div>
            <div className="absolute bottom-1/3 left-1/4 w-80 h-80 rounded-full bg-gradient-to-tr from-[#66EACE]/10 to-transparent blur-3xl"></div>
            
            {/* Data flow lines that pulse and move */}
            {[...Array(5)].map((_, i) => (
              <div
                key={`data-flow-${i}`}
                className="absolute h-0.5 w-1/3 data-flow-line"
                style={{
                  top: `${20 + i * 15}%`,
                  left: `${i % 2 === 0 ? '-10%' : '80%'}`,
                  background: `linear-gradient(${i % 2 === 0 ? 'to right' : 'to left'}, transparent, rgba(51,195,240,0.6), transparent)`,
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="flex flex-col text-left space-y-8">
                ...
                <div className="mb-8 flex items-center">
                  <div className="relative mr-4 group cursor-pointer animate-float">
                    <img src="/logo.svg" alt="EASY NET WORTH Logo" className="h-12 w-12 drop-shadow-[0_0_15px_rgba(51,195,240,0.5)] transition-all duration-300 group-hover:drop-shadow-[0_0_25px_rgba(51,195,240,0.8)]" />
                    <div className="absolute -inset-0.5 bg-gradient-to-br from-[#33C3F0]/20 to-transparent rounded-full blur-sm -z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  </div>
                  
                  <h1 className="text-2xl md:text-3xl font-bold tracking-tight group">
                    <span className="text-white relative overflow-hidden inline-block">
                    ...
                    <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#33C3F0] to-[#66EACE] ml-2 relative overflow-hidden inline-block">
                      <span className="relative z-10">NET WORTH</span>
                      <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-[#33C3F0] to-[#66EACE] group-hover:w-full transition-all duration-500 delay-100"></span>
                    </span>
                  </h1>
                </div>
                
                <h2 className="text-5xl md:text-6xl font-extrabold text-white leading-tight tracking-tight animate-text-focus-in">
                  <span className="block opacity-0 animate-fade-slide-up" style={{ animationDelay: "0.3s", animationFillMode: "forwards" }}>See what</span>
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-[#33C3F0] to-[#66EACE] opacity-0 animate-fade-slide-up" style={{ animationDelay: "0.6s", animationFillMode: "forwards" }}>
                    you're worth.
                  </span>
                </h2>
                
                <p className="text-xl text-gray-300 leading-relaxed max-w-lg opacity-0 animate-fade-slide-up" style={{ animationDelay: "0.9s", animationFillMode: "forwards" }}>
                ...
                <div className="flex flex-wrap gap-4 pt-4 opacity-0 animate-fade-slide-up" style={{ animationDelay: "1.2s", animationFillMode: "forwards" }}>
                  <Link to="/signup">
                    <Button className="bg-gradient-to-r from-[#33C3F0] to-[#66EACE] hover:from-[#33C3F0]/90 hover:to-[#66EACE]/90 text-black font-semibold text-lg px-8 py-5 rounded-lg shadow-lg shadow-[#33C3F0]/20 transition-all transform hover:translate-y-[-2px] relative overflow-hidden group">
                  ...
                  <Link to="/login">
                    <Button variant="outline" className="border-[#33C3F0]/40 hover:bg-[#33C3F0]/10 text-white font-medium text-lg px-8 py-5 rounded-lg transition-all relative overflow-hidden group">
                      <span className="absolute top-0 left-0 w-0 h-full bg-[#33C3F0]/20 group-hover:w-full transition-all duration-300"></span>
              ...
              {/* Right Column: Interactive Data Display */}
              <div className="relative w-full mt-8 lg:mt-0">
                {/* Enhanced Futuristic Data Display */}
                <div className="relative w-full max-w-lg mx-auto">
                  {/* Decorative elements */}
                  <div className="absolute -top-10 -right-10 w-20 h-20 border border-[#33C3F0]/20 rounded-full"></div>
                  <div className="absolute -bottom-12 -left-12 w-24 h-24 border border-[#66EACE]/20 rounded-full"></div>
                  
                  {/* Tech Frame with corners */}
                  <div className="absolute -inset-4 tech-frame">
                  ...
                  {/* Main content */}
                  <div className="glass-panel rounded-xl p-8 bg-gradient-to-br from-[#111827]/80 to-[#0a0d14]/90 backdrop-blur-xl">
                    <div className="mb-8 text-center">
                      <div className="text-sm uppercase tracking-wider mb-2 text-[#7A7F92]">Your Net Worth</div>
                      <div className="text-5xl font-bold inline-flex items-center bg-clip-text text-transparent bg-gradient-to-r from-[#33C3F0] to-[#66EACE] animated-glow">
                        €{netWorth.toLocaleString()}
                        <span className="ml-2 text-sm flex items-center text-green-400 bg-green-400/10 p-1 rounded-md">
                          <ArrowUp className="h-3 w-3 mr-1" />
                          5.2%
                        </span>
                      </div>
                      
                      <div className="w-full h-1 bg-[#1A1F2C] rounded-full mt-6 relative">
                        <div className="h-full bg-gradient-to-r from-[#33C3F0] to-[#66EACE] w-[80%] rounded-full relative animate-pulse-slow">
                          <div className="absolute -right-1 -top-1 w-3 h-3 rounded-full bg-[#66EACE] shadow-[0_0_8px_rgba(102,234,206,0.8)] animate-ping-slow"></div>
                        </div>
                      </div>
                    </div>
